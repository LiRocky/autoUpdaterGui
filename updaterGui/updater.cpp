...
const QStringList Updater::NormalUpdateArguments = QStringList{ QStringLiteral("--updater") };
const QStringList Updater::PassiveUpdateArguments = QStringList{ QStringLiteral("--updater") } + QStringList{ QStringLiteral("skipPrompt=true")};
const QStringList Updater::HiddenUpdateArguments =QStringList{QStringLiteral("--silentUpdate")};
...
Updater::UpdateInfo::UpdateInfo(QString _name, QVersionNumber _version, quint64 _size) 
