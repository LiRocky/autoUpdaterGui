...
bool UpdaterPrivate::startUpdateCheck()
{
	if(running)
		...
		mainProcess->setArguments(QStringList{QStringLiteral("--checkupdates")});
...
const char *UpdaterPrivate::NoUpdatesXmlException::what() const 
{
...
const char *UpdaterPrivate::InvalidXmlException::what() const 
{
